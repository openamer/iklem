...
def _builtin_tools() -> list[Tool]:
    ...
    return [
        ...
        Tool(name="browser_click", description="Click an element on the current page by CSS selector or text.", fn=browser.browser_click),
        Tool(name="browser_type", description="Type text into an input field on the current page.", fn=browser.browser_type),
        Tool(name="browser_submit", description="Submit a form (press Enter) on the current page.", fn=browser.browser_submit),
        Tool(name="browser_links", description="Return the links (text + href) on the current page.", fn=browser.browser_links),
        Tool(name="browser_screenshot", description="Take a screenshot of the current page and save it.", fn=browser.browser_screenshot),
        ...
        Tool(name="double_click", description="Double-click at screen coordinates (x, y).", fn=computer.double_click),
        Tool(name="right_click", description="Right-click at screen coordinates (x, y).", fn=computer.right_click),
        Tool(name="move_mouse", description="Move the mouse to screen coordinates (x, y).", fn=computer.move_mouse),
        Tool(name="mouse_position", description="Return the current mouse position (x, y).", fn=computer.mouse_position),
        Tool(name="scroll", description="Scroll the mouse wheel (positive = up, negative = down).", fn=computer.scroll),
        Tool(name="type_text", description="Type text at the current cursor position.", fn=computer.type_text),
        Tool(name="press_key", description="Press a single key (e.g. 'enter', 'tab', 'escape').", fn=computer.press_key),
        Tool(name="hotkey", description="Press a key combination (e.g. 'ctrl+s').", fn=computer.hotkey),
